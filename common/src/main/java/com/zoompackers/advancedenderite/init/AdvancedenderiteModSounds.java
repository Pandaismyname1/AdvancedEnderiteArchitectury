...
public class AdvancedenderiteModSounds {
	...
	public static final RegistrySupplier<SoundEvent> ADVANCED_ENDEDIRE_SOUNDS = REGISTRY.register("advanced_endedire_sounds", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("advancedenderite", "advanced_endedire_sounds")));
