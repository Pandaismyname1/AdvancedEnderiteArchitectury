...
public class GoldEnderiteHoeItem extends HoeItem {
	public GoldEnderiteHoeItem() {
		super(new Tier() {
			public int getUses() {
				return 5500;
			}
		...
		}, 0, 0.15f, new Properties().arch$tab(AdvancedenderiteModTabs.ADVANCED_ENDERITE).fireResistant());
	}
}
