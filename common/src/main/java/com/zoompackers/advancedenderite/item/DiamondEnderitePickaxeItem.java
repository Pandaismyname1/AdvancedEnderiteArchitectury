...
public class DiamondEnderitePickaxeItem extends PickaxeItem {
	public DiamondEnderitePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 7000;
			}
		...
		}, 1, -2.5f, new Properties().arch$tab(AdvancedenderiteModTabs.ADVANCED_ENDERITE).fireResistant());
	}
}
