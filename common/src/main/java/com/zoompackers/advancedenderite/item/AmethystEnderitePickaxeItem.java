...
public class AmethystEnderitePickaxeItem extends PickaxeItem {
	public AmethystEnderitePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 8000;
			}
		...
		}, 1, -2.4f, new Properties().arch$tab(AdvancedenderiteModTabs.ADVANCED_ENDERITE).fireResistant());
	}
}
