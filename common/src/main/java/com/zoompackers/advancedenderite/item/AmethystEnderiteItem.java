...
public abstract class AmethystEnderiteItem extends ArmorItem {
	public AmethystEnderiteItem(Type type, Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForType(Type type) {
				return new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 138;
			}

			@Override
			public int getDefenseForType(Type type) {
				return new int[]{10, 13, 15, 10}[type.getSlot().getIndex()];
			}
	...
	public static class Helmet extends AmethystEnderiteItem {
		public Helmet() {
...
//			return "advancedenderite:textures/models/armor/amethyst_enderite_layer_1.png";
//		}
	}

	public static class Chestplate extends AmethystEnderiteItem {
		public Chestplate() {
...
//		}
	...
	public static class Leggings extends AmethystEnderiteItem {
		public Leggings() {
...
//		@Override
//		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
//			return "advancedenderite:textures/models/armor/amethyst_enderite_layer_2.png";
//		}
	}

	public static class Boots extends AmethystEnderiteItem {
		public Boots() {
