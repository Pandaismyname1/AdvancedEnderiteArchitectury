...
public class GoldEnderiteShovelItem extends ShovelItem {
	public GoldEnderiteShovelItem() {
		super(new Tier() {
			public int getUses() {
				return 5500;
			}
		...
		}, 1, -2.85f, new Properties().arch$tab(AdvancedenderiteModTabs.ADVANCED_ENDERITE).fireResistant());
	}
}
