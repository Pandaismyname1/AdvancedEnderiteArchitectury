...
public class ArmorMaterials {
    ...
    private static RegistrySupplier<ArmorMaterial> CreateMaterial(String name, int[] setDefense, float toughness, float knockbackResistance, int enchantmentValue, Ingredient repairIngredient) {
        ...
        return ARMOR_MATERIAL.register(name, () -> new ArmorMaterial(enumMap,
                enchantmentValue,
